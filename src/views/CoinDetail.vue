<template>
  <div class="flex-col">
    ...
    <template v-if="!isLoading">
      ...
      <table>
        <tr :key="`${market.exchangeId}-${market.priceUsd}`" v-for="market in markets" class="border-b">
          <td>
          ...
          <td>
            <px-button :is-loading="market.isLoading || false" v-if="!market.url" @custom-click="getWebSite(market)"> <slot>Obtener Link </slot> </px-button>
